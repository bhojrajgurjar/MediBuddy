...
<body>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Profile</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
                   <li><a href="viewyourorders.jsp">View Orders</a></li>
                   <li><a href="updateaddress.jsp">Update Address</a></li>
         ...
         <li class="dropdown"><a href="#"><span>Products</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
             	<li><a href="displayproductpagination.jsp?page=1">Display Products</a></li>
               
                  <li><a href="category1.jsp">Health Care</a></li>
                  <li><a href="category2.jsp">Nutritions</a></li>
                  <li><a href="category3.jsp">Personal Care</a></li>  
            </ul>
          </li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Welcome to MediBuddy Online</h1>
